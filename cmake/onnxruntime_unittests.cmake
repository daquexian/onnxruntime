...
if (ONNXSIM_STANDALONE)
    add_executable(onnx_test_runner ${REPO_ROOT}/test.cpp)
else()
    add_library(onnx_test_runner ${REPO_ROOT}/test.cpp)
endif()
if (EMSCRIPTEN AND ONNXSIM_STANDALONE)
    set_target_properties(onnx_test_runner PROPERTIES LINK_FLAGS "-s DISABLE_EXCEPTION_CATCHING=0 -s FILESYSTEM=0 -s ALLOW_MEMORY_GROWTH=1 -s EXPORTED_FUNCTIONS=[_onnxsimplify_export,_create_exporter,_free_exporter,_get_buffer1,_get_buffer2,_get_buffer_size1,_get_buffer_size2,_get_buffer3,_get_buffer_size3] -s EXTRA_EXPORTED_RUNTIME_METHODS=[ccall,cwrap]")
endif()
if(MSVC)
